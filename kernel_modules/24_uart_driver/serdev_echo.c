...
/* Meta Information */
MODULE_LICENSE("GPL");
MODULE_AUTHOR("idogiat 4 GNU/Linux");
...
static struct of_device_id servdev_echo_ids[] = {
	{
		.compatible = "brightlight,mydev",
	}, { /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, servdev_echo_ids);
...
static struct serdev_device_driver serdev_echo_driver = {
	...
	.driver = {
		.name = "serdev-echo",
		.of_match_table = servdev_echo_ids,
	},
};
 ...
 */
static size_t serdev_echo_recv(struct serdev_device *serdev, const u8 *buffer, size_t size)
{
